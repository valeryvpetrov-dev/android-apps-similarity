...
def test_m_static_library_reduced_score_masks_only_unified_tpl_packages(monkeypatch):
    # Закрыто в волне 25: DEEP-25-MASK-PREFIX-MATCHING ввёл mask_format='package_prefix'
    # в library_reduced_score_canonical; compare_all делегирует через get_library_mask
    # и передаёт package-prefix mask как есть.
