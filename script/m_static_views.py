...
def compare_all(
    ...
    #
    # NOISE-24-MASK-CONTRACT: library-mask собирается единой функцией
    ...
    # чтобы test_library_mask_contract зафиксировал инвариант делегирования.
    # Если результат пустой — fallback на canonical default (library-слой
