...
def _framework_shift_default_fields(error: str | None = None) -> dict[str, Any]:
    return {
        ...
        "framework_shift_evidence_score_effect": "none",
        "framework_shift_evidence_score_included": False,
...
def _c05_static_default_fields(error: str | None = None) -> dict[str, Any]:
    fields: dict[str, Any] = {
        ...
        "c05_static_evidence_score_effect": "none",
        "c05_static_evidence_score_included": False,
