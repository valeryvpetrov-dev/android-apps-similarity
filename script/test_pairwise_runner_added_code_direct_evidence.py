#!/usr/bin/env python3
"""Direct added-code evidence in pairwise result."""
...
class TestPairwiseAddedCodeDirectEvidence(unittest.TestCase):
    def test_run_pairwise_adds_direct_added_code_evidence_without_score_effect(
        self,
    ) -> None:
        ...
        self.assertTrue(row["added_code_direct_evidence_applied"])
        self.assertEqual(row["added_code_direct_evidence_role"], "evidence_only")
        self.assertEqual(row["added_code_direct_score_effect"], "none")
        self.assertFalse(row["added_code_direct_score_included"])
        self.assertEqual(row["added_code_direct_right_only_method_count"], 2)
        self.assertEqual(row["added_code_direct_left_only_method_count"], 0)
        self.assertEqual(row["added_code_direct_common_method_id_count"], 2)
        self.assertEqual(row["added_code_direct_added_fingerprint_count"], 2)
        self.assertNotEqual(
            row["similarity_score_source"],
            "added_code_direct_evidence",
        )
        ...
        self.assertEqual(added_items[0]["score_effect"], "none")
        self.assertFalse(added_items[0]["score_included"])
        self.assertEqual(added_items[0]["right_only_method_count"], 2)
        self.assertEqual(
            added_items[0]["method_sample"],
